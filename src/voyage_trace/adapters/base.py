...
Every concrete adapter (LangSmith, Langfuse, OTel, A2A, MCP, raw) subclasses
:class:`TraceAdapter` and implements :meth:`TraceAdapter.adapt` to convert a
backend-specific trace payload into a :class:`CanonicalTrace`. The base class
provides:
